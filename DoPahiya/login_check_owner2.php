...
echo "				<div class=\"divider-h\">\n"; 
echo "					<span class=\"divider\"></span>\n"; 
echo "				</div><a href=\"update_availability2.php\" class=\"btn btn-lg btn-seashell\">Available</a><a href=\"repair_request.php\" class=\"btn btn-lg btn-alice-blue\">Request Repair</a>\n"; 
echo "				<h6 class=\"mg-md\">\n"; 
echo "					*Click when available\n"; 
echo "				</h6>\n"; 
echo "			</div>\n"; 
echo "		</div>\n"; 
echo "	</div>\n"; 
